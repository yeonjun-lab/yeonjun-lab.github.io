...
permalink: /foundations/languages/c/binary-layout/type-length-value는 왜 자주 쓰이는가/
layout: doc
section: foundations
...
### 7.1 확장 가능성이 중요한 프로토콜이라면 TLV를 적극 검토한다

필드 추가 가능성, optional field, backward/forward compatibility가 중요하면  
TLV는 매우 강력한 선택이다.

### 7.2 매우 작은 고정 메시지에는 과할 수 있다
...
### 7.3 unknown type 처리 정책을 명확히 한다
